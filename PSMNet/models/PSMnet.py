...
from models.costvolume import CostVolume
...
class PSMNet(nn.Module):
    ...
    def forward(self, left_img, right_img):
        ...
        # temp = CostVolume(left_cost, right_cost, position='left', method='subtract',
        #                   k=4, batch_size=left_cost.size(0), channel=32, D=192, H=256, W=512)
        # print(temp.size())    # torch.Size([1, 12, 32, 64, 128])
        # exit()
        ...
        print(cost_volume.size())    # torch.Size([1, 64, 48, 64, 128])
